...
# This script runs on instances with a node_type tag of "elk-es-coordinator"
...
id: $PNDA_CLUSTER-elk-es-coordinator-$1
EOF

echo $PNDA_CLUSTER-elk-es-coordinator-$1 > /etc/hostname
hostname $PNDA_CLUSTER-elk-es-coordinator-$1
