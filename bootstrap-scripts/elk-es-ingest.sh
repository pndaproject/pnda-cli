...
# This script runs on instances with a node_type tag of "elk-es-ingest"
...
id: $PNDA_CLUSTER-elk-es-ingest-$1
EOF

echo $PNDA_CLUSTER-elk-es-ingest-$1 > /etc/hostname
hostname $PNDA_CLUSTER-elk-es-ingest-$1
